        ...
        if not df.empty:
            for _, row in df.iterrows():
                try:
                    ...
                    # Parse Column I safely for TV Network parameters
...
def build_match_banner(match, is_live=False, is_result=False, match_idx=2):
    ...
    <style>
        ...
        .banner-bottom-time {{ background-color: #ff7d23; padding: 8px 15px; font-size: 12px; font-weight: 700; color: #FFFFFF; }}
